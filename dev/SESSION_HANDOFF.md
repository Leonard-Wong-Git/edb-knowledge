...
7. commits（**已 push origin/main**）: `eb9d90b`(清訊號) → `59b8d2b`(404 band-aid) → `6309333`(v3.2.0 release) → 本治理 commit。playbook repo `7057db8`。Supabase：Leonard UPDATE 383 `sag_2025_11` url（verified live）。
