...
1. **Phase 3a batch ranking polish ~14-17 sources**（S122-S125c+S130 累計 + Phase 3b live smoke 未進一步揭新 ranking issue；**S133 g29 確認 false-alarm 從清單剔走**）：tech_kla / chi_hist / ls_jss / arts ranking competition / econ_sss_supp competition / 等。Case-by-case 診斷 dedicated route or query expansion or per-source quota。Fresh session 較佳（each source needs individual judgment）。
