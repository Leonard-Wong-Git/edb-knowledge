...
7. commits: `a6547c6`(文件分析 code) → `d17c25d`(文件分析 governance) → `46376f4`(IMC 治理入庫) → `60da7f0`(IMC governance) → `37995bc`(Cloudflare beacon ×4 HTML + footer 細字) → governance commit（本次）。
