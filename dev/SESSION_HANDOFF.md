...
1. **下一階段方向（待 Leonard 明示）**：(a) **g14《校本資優培育課程指引》+ sen_curr_area + gifted_policy_docs 仍 0 chunks**（SEN-adjacent gap、registry verified 但從未 ingest、可補同 g10/g19 §E.12 pattern、低優先）；(b) Q4 對外契約收斂（見 #3）；(c) §8b rule 2 automation（見 #3）；(d) 39→148 guidelines 擴展。
