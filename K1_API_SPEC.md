...
```json
{
  "_meta": {
    ...
    "stats": { "facts": 455, "chunks": 17007, "sources": 300, "guidelines": 151, "topics": 7 }
  },
  "finance": {
    "_label": "財務 / 採購 / 津貼 / 撥款",
    "_keywords_zh": ["採購", "財務", ...],
...
## 6. guidelines.json 格式（全集投影，現為 151 份）
...
>
> **現況（2026-09-14 實測）：`_meta.count` = 151，in-app `GUIDELINES_REGISTRY` = 170。**
